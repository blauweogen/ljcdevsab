<span class="awpcp-date-range-search">
    <span>
        ...
        <input id="<?php echo esc_attr( $html['base-id'] ); ?>-from" class="inputbox <?php echo esc_attr( $html['class'] ); ?>" type="text" datepicker-placeholder value="<?php echo esc_attr( $from_date ? awpcp_datetime( 'awpcp-date', $from_date ) : '' ); ?>">
    ...
    <span>
        ...
        <input id="<?php echo esc_attr( $html['base-id'] ); ?>-to" class="inputbox <?php echo esc_attr( $html['class'] ); ?>" type="text" datepicker-placeholder value="<?php echo esc_attr( $to_date ? awpcp_datetime( 'awpcp-date', $to_date ) : '' ); ?>">

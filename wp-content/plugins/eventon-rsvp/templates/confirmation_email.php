	...
	<tr>
		<td style='<?php echo $__sty_td;?>'>
			<div class='event_date' style='<?php echo $__styles_06;?>'>	
				<p style='padding-top:10px;color:#555555; text-transform:uppercase; font-size:12px; margin:0px; line-height:100%'><?php echo date('D',$unix_start);?></p>
			...
			<div style="padding:20px; font-family:'open sans'">
				<p style='<?php echo $__sty_lh;?>font-size:18px; font-style:italic; margin:0'><?php echo $eventon_rs->lang('evoRSLX_009', 'You have RSVP-ed for', $lang)?></p>
				...
				<p style='<?php echo $__styles_02;?> padding-bottom:40px;'><span style='<?php echo $__styles_02a;?>'><?php echo $eventon_rs->lang('evoRSLX_008', 'Event Time', $lang)?>:</span> <?php echo $__date['html_prettytime'];?></p>
				<?php 
				//additional fields
				for($x=1; $x<4; $x++){
				...
				<?php do_action('eventonrs_confirmation_email', $args['rsvp_id'], $rsvp_pmv);?>

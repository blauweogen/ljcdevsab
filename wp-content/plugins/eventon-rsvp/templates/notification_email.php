 ...
 */
	...
	//event time
		$__date = $eventon_rs->frontend->_event_date($e_pmv, $repeat_interval);
...
<table width='100%' style='width:100%; margin:0;font-family:"open sans"'>
	<tr>
		<td style='<?php echo $__sty_td;?>'>			
			<div style="padding:20px; font-family:'open sans'">
				<p style='<?php echo $__sty_lh;?>font-size:18px; font-style:italic; margin:0'><?php echo $eventon_rs->lang('evoRSLX_010', 'You have received a new RSVP for', $lang)?></p>
				...
				<?php echo $__item_p_beg;?><?php echo $eventon_rs->lang('evoRSL_009a', 'Phone Number', $lang)?>:</span> <?php echo evo_meta($rsvp_pmv,'phone');?></p>

				<?php echo $__item_p_beg;?><?php echo $eventon_rs->lang('evoRSLX_003', 'Spaces', $lang)?>:</span> <?php echo evo_meta($rsvp_pmv,'count');?></p>
				<!-- event time -->
				<?php echo $__item_p_beg;?><?php echo $eventon_rs->lang('evoRSLX_008', 'Event Time', $lang)?>:</span> <?php echo $__date['html_prettytime'];?></p>
	...
	<tr>
		<td  style='padding:20px; text-align:left;border-top:1px dashed #d1d1d1; font-style:italic; color:#ADADAD'>					
			<p style='<?php echo $__sty_lh.$__sty_m0;?>'><a target='_blank' href='<?php echo $rsvp_edit_link; ?>'>View RSVP</a> | <a target='_blank' href='<?php  echo $event_edit_link;?>'>Edit Event</a></p>
		</td>
	</tr>
	<?php endif;?>
</table>

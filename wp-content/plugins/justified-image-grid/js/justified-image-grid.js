	...
	$.justifiedImageGrid = function(element, options){
		...
		plugin.init = function(){
			...
			animateBorder = function(el, findVal, eType, borderWidth){
				el.find(findVal).hoverFlow(eType, {'borderLeftWidth': borderWidth, 'borderTopWidth': borderWidth, 'borderRightWidth': borderWidth, 'borderBottomWidth': borderWidth}, s.animSpeed);
			};
